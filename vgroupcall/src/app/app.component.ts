...
export class AppComponent implements AfterViewInit {
  title = 'app';
	...
	joinSession() {
		...
		this.session = this.OV.initSession('wss://' + location.hostname + ':8443/' + this.sessionId + '?secret=pakgon#pwd');
	...
	private generateParticipantInfo() {
		...
		this.sessionId = 'PublicSession';
		this.userName = 'anonymous' + Math.floor(Math.random() * 100);
	}
